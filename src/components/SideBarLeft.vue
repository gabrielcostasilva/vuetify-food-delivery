<template>
  <v-navigation-drawer app color="green accent-3" dark>
    <v-list-item class="px-2 py-5">
      <v-list-item-title class="text-capitalize" align="center">
        <v-icon x-large class="pr-2">fas fa-hamburger</v-icon>AEE POS
      </v-list-item-title>
    </v-list-item>
    <v-list shaped>
...
export default {
  data() {
    return {
      selectedItem: 0,
      items: [
        { icon: 'fas fa-shipping-fast', text: 'OVERVIEW', route: '/overview' },
        ...
        { icon: 'fas fa-cogs', text: 'TESTIMONIALS', route: '/testmonials' },
